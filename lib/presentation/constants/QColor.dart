...
class QColor {
  ...
  static final Color globalErrorInputBorder = Colors.red;
  static final Color globalNormalInputBorder = Colors.grey;

  static final Color searchTextAndCursor = Colors.grey[600];
  static final Color tffSearchGlobalFocusColor = Colors.grey[200];
