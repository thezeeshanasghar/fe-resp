...
//                 TextButton(
//                   onPressed: () {
//                     InvoiceArguments arguments = InvoiceArguments(
//                       previousDate: row['date'],
//                       consultationDate: row['consultationDate'],
//                       name: '${row['firstName']} ${row['lastName']}',
//                       fatherName: row['fatherHusbandName'],
//                       dateOfBirth: row['dateOfBirth'],
//                       email: row['email'],
//                       contactNumber: row['contact'],
//                       appointmentType: row['type'],
//                       appointmentPatientCategory: row['patientCategory'],
//                       appointmentDate: row['date'],
//                       appointmentConsultationDate: row['consultationDate'],
