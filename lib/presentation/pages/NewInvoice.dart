...
class _NewInvoiceState extends State<NewInvoice> {
      ...
      children: [
        Padding(
          ...
          child: TextFormField(
              autofocus: false,
              decoration: InputDecoration(
                  prefixIcon: Icon(Icons.monetization_on), border: OutlineInputBorder(), labelText: 'Total (rupees)'),
              validator: (String value) {
                if (value.isEmpty) {
                  return 'This field cannot be empty';
                }
      ...
      child: Container(
        ...
        child: Padding(
          ...
          child: DropdownButton<String>(
            ...
            items: <String>['Select Payment Type', 'Cash', 'Credit Card', 'Easypaisa']
                .map<DropdownMenuItem<String>>((String value) {
              return DropdownMenuItem<String>(
                value: value,
                child: Text(value),
      ...
      child: Container(
        ...
        child: Padding(
          ...
          child: DropdownButton<String>(
            ...
            items: <String>['Select Doctor', 'Dr. Salman', 'Dr. Amna', 'Dr. Ali']
                .map<DropdownMenuItem<String>>((String value) {
              return DropdownMenuItem<String>(
                value: value,
                child: Text(value),
      ...
      child: Container(
        ...
        child: Padding(
          ...
          child: DropdownButton<String>(
            ...
            items: <String>['Select Doctor Type', 'Pediatrician', 'Psychiatrist', 'Dermatologist']
                .map<DropdownMenuItem<String>>((String value) {
              return DropdownMenuItem<String>(
                value: value,
                child: Text(value),
      ...
      children: [
        Padding(
          ...
          child: TextFormField(
              ...
              decoration: InputDecoration(
                  prefixIcon: Icon(Icons.person), border: OutlineInputBorder(), labelText: 'Local Area'),
              validator: (String value) {
      ...
      children: [
        Padding(
          ...
          child: TextFormField(
              ...
              decoration:
                  InputDecoration(prefixIcon: Icon(Icons.person), border: OutlineInputBorder(), labelText: 'City'),
              validator: (String value) {
                if (value == null || value.isEmpty) {
                  return 'This field cannot be empty';
                }
      ...
      children: [
        Padding(
            ...
            child: TextFormField(
              ...
              decoration:
                  InputDecoration(prefixIcon: Icon(Icons.person), border: OutlineInputBorder(), labelText: 'Name'),
              validator: (String value) {
                if (value == null || value.isEmpty) {
                  return 'This field cannot be empty';
                }
      ...
      children: [
        Padding(
            ...
            child: TextFormField(
              autofocus: false,
              decoration:
                  InputDecoration(prefixIcon: Icon(Icons.roofing), border: OutlineInputBorder(), labelText: 'Block'),
              validator: (String value) {
                if (value == null || value.isEmpty) {
                  return 'This field cannot be empty';
                }
      ...
      children: [
        Padding(
          ...
          child: TextFormField(
              ...
              decoration: InputDecoration(
                  prefixIcon: Icon(Icons.person), border: OutlineInputBorder(), labelText: 'Father Name'),
              validator: (String value) {
                if (value == null || value.isEmpty) {
                  return 'This field cannot be empty';
                }
  ...
  pickDateThree() async {
    DateTime date = await showDatePicker(
        context: context, initialDate: DateTime.now(), firstDate: DateTime.now(), lastDate: DateTime.now());
    if (date != null) {
      setState(() {
